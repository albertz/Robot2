...
{$ENDIF}
  ...
  ROOM_HEIGHT = 20;
  KNAPSACK_WIDTH = 9; // place count in the knapsack
  KNAPSACK_HEIGHT = 3;
...
type
  ...
  public
    ...
    MyDiamonds: array of TDiamondSet; // set diamonds
...
begin
  ...
  f := GetMainPlayerIndex();
  if f < 0 then exit; // don't do anything
        ...
        begin
          ...
          begin
            ...
            ShowMessage(
                        ...
                        'geschafft! Der König dieser Robot-Welt wurde ' +
                        'besiegt.' + LineEnding +
                        LineEnding +
